...
class RecentlyPostViewPage extends StatefulWidget {
  static const routeName = "/recentPost";
  const RecentlyPostViewPage({super.key});

  @override
  State<RecentlyPostViewPage> createState() => _RecentlyPostViewPageState();
}

class _RecentlyPostViewPageState extends State<RecentlyPostViewPage> {
  List bookmarkList = [
    {
